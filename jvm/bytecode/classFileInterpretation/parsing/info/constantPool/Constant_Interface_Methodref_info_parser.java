...
public class Constant_Interface_Methodref_info_parser extends Constant_info_parser {
    private short cls_info_index;
    private short name_type_index;

    protected Constant_Interface_Methodref_info_parser(InputStream inputStream) {
        super(inputStream);
    }
    ...
    protected Constant_info doParse() {
        ...
        return new Constant_Interface_Methodref_info(this.cls_info_index, this.name_type_index);
