...
class DelayedTaskConsumer implements Runnable {
    ...
    public void run() {
        try {
            ...
            /**
             * when calling 'q.take()',in the 'take' method,
             * Causes the current thread to wait until it is
             * signalled or interrupted, or the specified waiting time elapses
             */
...
/**
 * the DelayQueue.add() method will sort the elements by the delay
 * of the element,and when calling 'take' method, it will await for
 * the specified element that it's fetched out
 */
